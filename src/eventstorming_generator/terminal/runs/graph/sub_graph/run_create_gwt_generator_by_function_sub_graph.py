...
def run_create_gwt_generator_by_function_sub_graph(command_args):
    run_name = "run_create_gwt_generator_by_function_sub_graph"

    try:

        run_subgraph = create_gwt_generator_by_function_subgraph()
        result: State = run_subgraph(create_gwt_generator_by_function_sub_graph_inputs)
        ...
        TerminalHelper.save_dict_to_temp_file({
            ...
            "totalSeconds": result.subgraphs.createGwtGeneratorByFunctionModel.total_seconds
        }, run_name)

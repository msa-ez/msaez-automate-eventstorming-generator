...
from ....commons.graph import execute_create_aggregate_by_functions_sub_graph
from .....constants import RG

def run_create_aggregate_by_functions_sub_graph(command_args):
    run_name = "run_create_aggregate_by_functions_sub_graph"
    after_stop_node = RG.CREATE_AGGREGATES
